...
namespace L3_DBEntityFramework.Controllers
{
    ...
    public class CatsController : Controller
    {
        ...
        public CatsController( CatsContext dbContext, IConfiguration _config)
        {
            _db = dbContext;
        ...
        public IActionResult Index()
        {
            return Content($"Meow~ Meow~ Meow~\n" +
                "[Config]/[ShowMeow]/[AddMeowMeow]/[FuckOutMeow]/[GetMeowById/{Id}]");
        }

        [HttpGet("Config")]
        public IActionResult ShowConfig()
        {
            return Content( $"Current Connection String {Configuration.GetSection("ConnectionString")["Default"]}\n");
        }
